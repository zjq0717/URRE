...
class LatentEncoder(nn.Module):
    ...
    def __init__(self, num_hidden, num_latent, input_dim):
        ...
        self.penultimate_layer = Linear(num_hidden, 4, w_init='relu')
        self.mu = Linear(4, 4)
        self.log_sigma = Linear(4, 4)
...
class DeterministicEncoder(nn.Module):
    ...
    def __init__(self, num_hidden, num_latent, input_dim):
        ...
        self.penultimate_layer = Linear(num_hidden, 4)
    def forward(self, context_x, context_y, target_x):
        ...
        query = self.penultimate_layer(query)
        return query
...
class Decoder(nn.Module):
    ...
    def __init__(self, num_hidden, input_dim):
        ...
        self.final_projection = Linear(num_hidden+4, 1)
        
    def forward(self, z, target_x):
